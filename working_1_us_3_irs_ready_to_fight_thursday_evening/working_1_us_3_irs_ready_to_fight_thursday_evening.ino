...
void USreading() {
  ...
  /*
    ...
    duration1 = pulseIn(ECHO_PIN1, HIGH, 5000); // Measure the time for echo
  ...
  */
  ...
  /*
    ...
    duration3 = pulseIn(ECHO_PIN3, HIGH, 5000); // Measure the time for echo
